...
desenhar(corpoCarro, 1.0, 0.0, 0.0);    

const tetoCarro = new Float32Array([
    -0.3,  0.2,   
    -0.3,  0.0,   
     0.3,  0.0,   
...
desenhar(tetoCarro, 0.4, 0.7, 1.0); 

const rodaEsquerda = criarCirculo(-0.35, -0.2, 0.12);
desenhar(rodaEsquerda, 0.1, 0.1, 0.1); 

const rodaDireita = criarCirculo(0.35, -0.2, 0.12);
desenhar(rodaDireita, 0.1, 0.1, 0.1);

const calotaEsquerda = criarCirculo(-0.35, -0.2, 0.05);
desenhar(calotaEsquerda, 0.7, 0.7, 0.7);

const calotaDireita = criarCirculo(0.35, -0.2, 0.05);
desenhar(calotaDireita, 0.7, 0.7, 0.7);
